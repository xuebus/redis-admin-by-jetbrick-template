...
<div class="col-sm-12 col-md-12 main">
	...
	<div class="col-sm-3 col-md-3">
		<button type="button" class="btn btn-info" data-toggle="modal" data-target="#addServerModal" data-whatever="addServer">添加服务器</button>
		<button type="button" class="refresh_btn btn btn-default" >刷新</button>
	</div>
	...
	<div class="row col-sm-offset-3 col-md-offset-3 ">
		...
		<div class="col-sm-offset-5 col-md-offset-5 ">
			<button type="button" class="btn btn-info" data-toggle="modal" data-target="#addModal" data-whatever="add">添加</button>
			<button type="button" class="edit_btn btn btn-info" >查看/修改</button>
			<button type="button" class="delete_btn btn btn-info" value1="delete" >删除</button>
			<button type="button" class="refresh_btn btn btn-default" >刷新</button>
			<button type="button" class="changeShowType_btn btn btn-default" value1="${change2ShowType}" >${change2ShowType} 类型</button>
		</div>
	</div>
