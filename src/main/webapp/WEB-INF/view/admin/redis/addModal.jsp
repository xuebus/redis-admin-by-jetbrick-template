	...
	<div class="modal-dialog modal-lg" group="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="addModalLabel">添加服务器</h4>
			</div>
			<div class="modal-body">
				<form id="addModalForm">
					...
					<div class="form-group">
						<label for="recipient-name" class="control-label">数据库编号:</label>
					...
					<div class="form-group">
						<label for="recipient-name" class="control-label">数据类型:</label>
					...
					<span class="label label-info">键</span>
					...
					<span class="label label-info">值</span>
			...
			<div class="modal-footer">
				...
				<button value1="add" type="button" class="add_KV_btn btn btn-info">添加</button>
			</div>
		</div>
	</div>
</div>