...
<div class="modal fade bs-example-modal-lg" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel">
	<div class="modal-dialog modal-lg" role="document">Auto
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="back_btn close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
				<h4 class="modal-title" id="updateModalLabel">查看/修改 redisKV</h4>
			</div>
			<div class="modal-body">
				...
				<div class="input-group">
				  <span class="input-group-addon" >数据库编号</span>
					...
					<table id="STRINGFormTable" class="table table-striped table-bordered" >
						...
						<tbody>
							<tr style="display: none;">
								...
								<td><button type="button" class="update_redis_btn btn btn-info">修改</button></td>
							</tr>
						</tbody>
					</table>
				</form>
				...
				<form id="LISTForm" style="display: none;">
					<label for="recipient-name" class="control-label">值(REMARK:leftpop , leftpush)</label>
					<table id="LISTFormTable" class="table table-striped table-bordered" >
						...
						<tbody>
							<tr style="display: none;">
								...
								<td><button type="button" class="update_redis_btn btn btn-info">从左添加</button></td>
							</tr>
						</tbody>
					</table>
				</form>
				...
				<form id="SETForm" style="display: none;">
					<label for="recipient-name" class="control-label">值(REMARK:minus is random)</label>
					<table id="SETFormTable" class="table table-striped table-bordered" >
						...
						<tbody>
							<tr style="display: none;">
								...
								<td><button type="button" class="update_redis_btn btn btn-info">更新</button></td>
							</tr>
						</tbody>
					</table>
				</form>
				...
				<form id="ZSETForm" style="display: none;">
					<table id="ZSETFormTable" class="table table-striped table-bordered" >
						<thead>
							<tr>
								<th class="col-sm-5 col-lg-5">得分</th>
								<th>元素</th>
								<th class="col-sm-1 col-lg-1">操作</th>
							</tr>
						</thead>
				...
				<form id="HASHForm" style="display: none;">
					<table id="HASHFormTable" class="table table-striped table-bordered" >
						<thead>
							<tr>
								<th class="col-sm-5 col-lg-5">字段</th>
								<th>value</th>
								<th class="col-sm-1 col-lg-1">操作</th>
							</tr>
						</thead>
